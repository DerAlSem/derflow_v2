---
name: humanizer-ru
description: "Очистка русского текста от нейросетевой манеры с сохранением смысла, фактов и голоса. Триггеры: очеловечь, humanizer, убери нейросетевое, почему текст звучит как нейросеть. Вторая ступень конвейера sales-copy. Вычитка, грамматика и типографика — не сюда, это ru-text. Режимы: редактура, аудит без переписывания, точечная правка одной категории. НЕ используй для: перевод, написание с нуля, грамматика без стилистики, код."
license: MIT
---
...
- **Свой черновик** — ОТКЛЮЧЁН локальной правкой (см. `VENDOR.md`): свой русский
  вывод держит ru-text, второй молчаливый редактор с противоположными правилами
  типографики дал бы перетягивание каната.
